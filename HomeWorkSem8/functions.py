def show_data() -> None:
    ...
    with open('C:/Users/user/Desktop/Учеба/PythonHomeWork/HomeWorkSem8/book.txt', 'r', encoding='utf-8') as f:
        print(f.read())
...
def add_data() -> None:
    ...
    with open('C:/Users/user/Desktop/Учеба/PythonHomeWork/HomeWorkSem8/book.txt', 'w', encoding='utf-8') as f:
        f.write(f'\n{fio} | {tel_num}')
